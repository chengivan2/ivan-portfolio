...
import "./HomeComponentStyles/Hero.css";
      ...
      <div className="hero-section-columns">
        <div className="hero-section-column-one">
          ...
          <p className="hero-section-paragraph">
            Guru? Maybe not. But <Hometypinganimation />.
          </p>
          <div className="hero-section-main-cta">
            <a href="#homecontactform">
              <div className="hero-section-main-cta-link">Talk to me</div>
            </a>
          </div>
        </div>
        ...
        <div className="hero-section-column-two">
          <img
            className="hero-section-ivanthedevbot"
