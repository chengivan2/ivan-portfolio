      ...
      <div className="contact-content-hook">
        ...
        <div className="contact-content-hook-text">
          ...
          <div className="contact-content-hook-text-paragraph">
            <p>I am Ivan. A full-stack web developer.</p>
            <br />
            <p className="contact-hook-poem">
              <b>
                In the quiet whispers of dawn's embrace, My words bloom like
                stars in cosmic space. Reach out, and let our stories
                intertwine, For connections forged here are forever divine.
              </b>
            </p>
          </div>
        </div>
